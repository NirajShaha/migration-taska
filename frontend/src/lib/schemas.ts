...
// Type Form Schema
const typeFormSchemaBase = z.object({
  typModel: z
    .string()
  ...
  typApprDateDay: z.number().min(1).max(31).optional(),
  typApprDateMonth: z.number().min(1).max(12).optional(),
  typApprDateYear: z.number().min(1900).max(2100).optional(),
...
export const TypeFormSchema = typeFormSchemaBase;
...
export interface TypeFormData {
  ...
  typApprDateDay?: number;
  typApprDateMonth?: number;
  typApprDateYear?: number;
...
export const VariantFormSchema = z.object({
  ...
  varCocNoArrCyl: z
    .string()
    .max(5, "No. of cylinders max 5 characters")
    .optional(),
  varCocDirectInj: z
    .string()
    .max(5, "Direct injection max 5 characters")
    .optional(),
  varCocWrkPrin: z
    .string()
    .max(40, "Working principle max 40 characters")
    .optional(),
  varCocEngCode: z.string().max(10, "Engine code max 10 characters").optional(),
  varCocEngMan: z
    .string()
    .max(25, "Engine manufacturer max 25 characters")
    .optional(),

  // ===== AXLES & CONFIGURATION =====
  varAxlesCocVal: z
    .string()
    .max(50, "Axles config max 50 characters")
    .optional(),
  ...
  axleWheelField1_1: z
    .string()
    .max(12, "Axle/wheel (1) max 12 characters")
    .optional(),
  axleWheelField1_2: z
    .string()
    .max(10, "Axle/wheel (2) max 10 characters")
    .optional(),
  ...
  heightField5_1: z
    .string()
    .max(10, "Height (max) max 10 characters")
    .optional(),
  heightField5_2: z
    .string()
    .max(10, "Height (min) max 10 characters")
    .optional(),

  // Field 6: Rear Overhang
  rearOverhangField6: z
    .string()
    .max(10, "Rear overhang max 10 characters")
    .optional(),

  // Field 7: Track - Axle
  trackAxleField7: z
    .string()
    .max(20, "Track-Axle max 20 characters")
    .optional(),

  // Field 8: Type of Body
  typeBodyField8: z
    .string()
    .max(25, "Type of body max 25 characters")
    .optional(),

  // Field 30: Class of Vehicle
  classVehicleField30: z
    .string()
    .max(10, "Class of vehicle max 10 characters")
    .optional(),

  // Field 30.1: No and Conf. of Doors
  doorsField30_1: z
    .string()
    .max(50, "Doors config max 50 characters")
    .optional(),
  ...
  varNewmodActmasInd: z
    .string()
    .max(1, "ACTMASS ind max 1 character")
    .optional(),
...
export const UnifiedFormSchema = z.object({
  ...
  typeDescription: z
    .string()
    .max(28, "Type description max 28 characters")
    .optional(),
  ...
  approvalDate: z
    ...
    .regex(
      /^\d{2}\/\d{2}\/\d{4}$|^$/,
      "Approval date must be DD/MM/YYYY format"
    )
    .optional(),
  ...
  posAxlesWithTwinWheels: z
    .string()
    .max(12, "Twin wheels pos max 12 characters")
    .optional(),
  ...
  position: z
    ...
    .refine(
      ...
      "Position must not contain commas"
    )
    .optional(),
  interconnection: z
    .string()
    ...
    .refine(
      (val) => !val || !val.includes(","),
      "Interconnection must not contain commas"
    )
    .optional(),
  ...
  lengthWithTowbar: z
    .string()
    .max(9, "Length with towbar max 9 characters")
    .optional(),
  ...
  classOfVehicle: z
    ...
    .refine(
      (val) => !val || /^(I|II|III|IV|A|B|C)$/.test(val),
      "Class must be I, II, III, IV, A, B, or C"
    )
    .optional(),
  noConfDoors: z
    .string()
    .max(50, "No and conf of doors max 50 characters")
    .optional(),

  // ===== HA003R: CERTIFICATE OF CONFORMITY =====
  vinPlateAttachment: z
    .string()
    .max(70, "VIN plate attachment max 70 characters")
    .optional(),
  vinPlateLocation: z
    .string()
    .max(70, "VIN plate location max 70 characters")
    .optional(),
  commercialDescription: z
    .string()
    .max(70, "Commercial description max 70 characters")
    .optional(),
  remarks: z.string().max(375, "Remarks max 375 characters").optional(),
  additionalInfo: z
    .string()
    .max(375, "Additional info max 375 characters")
    .optional(),

  // ===== HA003D: ENGINE SPECIFICATIONS =====
  engineCode: z.string().max(10, "Engine code max 10 characters").optional(),
  engineManufacturer: z
    .string()
    .max(25, "Engine manufacturer max 25 characters")
    .optional(),
  workingPrinciple: z
  ...
  engineCycle: z
    ...
    .refine(
      (val) => !val || !val.includes(","),
      "Engine cycle must not contain commas"
    )
    .optional(),
  engineIgnition: z
    .string()
    ...
    .refine(
      (val) => !val || !val.includes(","),
      "Engine ignition must not contain commas"
    )
    .optional(),
  directInjection: z
    .string()
    .max(5, "Direct injection max 5 characters")
    .optional(),
  noArrangementCylinders: z
    .string()
    .max(12, "Cylinders max 12 characters")
    .optional(),
  ...
  maxHourlyOutputElec: z
    .string()
    .max(8, "Max hourly output max 8 characters")
    .optional(),
  maxNetPowerElec: z
    .string()
    .max(8, "Max net power elec max 8 characters")
    .optional(),
  max30MinPowerElec: z
    .string()
    .max(8, "Max 30min power max 8 characters")
    .optional(),

  // ===== HA003U: TIRE & DATA SPECIFICATIONS =====
  tyreValue: z
    .string()
    .max(1, "Tire value max 1 character")
    .optional(),
